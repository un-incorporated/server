...
## Conformance test vectors (Data Access Transparency v1 Appendix C.1)
...
- Conformance statement in Uninc Server's README: *"This binary implements Data Access Transparency v1 and passes all 17 conformance vectors in `testdata/dat-v1-vectors/`."*
